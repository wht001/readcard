...
public class MainMenu extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Button buttonConsole3 = (Button) findViewById(R.id.button3);
        buttonConsole3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(MainMenu.this, ConsoleActivity3.class));
            }
        });
